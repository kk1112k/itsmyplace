...
<div class="container">
	...
	<form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">
		<input type="text" name="userName" id="userName" maxlength="20" value="작성자명 : ${user.userName}" style="ime-mode:active; background-color:#90D5EB" class="form-control mt-4 mb-2" placeholder="이름을 입력해주세요." readonly />

...
<div class="container">
	...
	<form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">
		<input type="text" name="userId" id="userId" maxlength="20" value="작성자 아이디 : ${user.userId}" style="ime-mode:active; background-color:#90D5EB" class="form-control mt-4 mb-2" placeholder="아이디를 입력해주세요." readonly />

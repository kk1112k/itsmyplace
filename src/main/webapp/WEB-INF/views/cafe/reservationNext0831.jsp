...
function imageselect(phtNum, menuNums)
{
	...
	basket3 += "			<div class='basketcmd' id='basketcmd" + num + "'><button type='button' class='btn btn-primary btn-sm' id='p_abutton" + num + "' onclick='delItem(" + num + ");'>삭제</button></div>"
...
function onlyPointPay(){
	...
	if($("#origin_Price").val() != $("#use_Point").val() || $("#result_Price").val() != 0){
		alert("포인트를 전액 사용하지 않았습니다. 결제를 취소합니다.");
		return;
	}
...
<form name="orderform" id="orderform" method="post" class="orderform" action="/Page" onsubmit="return false;" style="margin:0 auto; padding:0; max-width:1170px;">    
	...
	<div class="basketdiv" id="basket" style="margin:0 auto; padding:0;">
		...
		<div class="row data" style="padding-top: 40px;text-align: right;">
			<h3 style="display: inline; padding-right: 20px;">총 주문개수 : <span class="bold" id="totalCount_s">0</span> 개</h3>
...
<div class="checkout shopping">
	<div class="container">
	   <div class="row" style="padding-top: 400px;">
	    <div class="col-md-8">
	       <div class="content">
	          <img src="/resources/images/logo21.png" alt="image" width=340" height="80" />
	       </div>
	    </div>
	     <div class="col-md-4">
	       <div class="content">
	          <img src="/resources/images/logo23.png" width="300" height="80"/>
	       </div>
	    </div>
	    <div class="col-md-8">
	       <div class="block billing-details">
	          <h2 class="widget-title">주문자 정보</h2>
				...
				<div class="payment">
					<div class="card-details">
						<form  class="checkout-form">                                                      
							...
							<img src="/resources/images/great.png" alt="image" width="150" height="150" onclick='onlyPointPay();'/>
		...
		<div class="col-md-4" style="padding-top: 10px;">
			<div class="block product-checkout-details">
				<div class="">
					...
					<div>결제금액</div>
					<div><h2><span class="bold" id="origin_Price_s"></span>원</h2> </div>
					<input type="hidden" name="origin_Price" id="origin_Price" value="0"/>
					
				<div>
					<div>포 인 트</div>
					<input type="text" name="use_Point" id="use_Point" value="0" min="100" max="${user.totalPoint}" onchange="changePoint($('#origin_Price').val(),${user.totalPoint},100,100)"> p 
				</div>

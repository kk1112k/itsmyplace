	      ...
	      success: function(response){
	         if(response.code==0){
	            ...
	            for(var i=0; i<seatNumList.length; i++){
	              ...
	              $("#img"+SeatNum).removeAttr("src", "/resources/images/reservation/chairs.png");
...
<div class="container">
    ...
    <div class="seatStructure">
   	 ...
   	 <div style="text-align: right; padding-bottom: 10px;">
	   	 <button class="btn btn-main" id="btnResetTb" style="width: 166px;background: #;background: #ececec;color: dodgerblue;">좌석 초기화</button>
   	 </div>
